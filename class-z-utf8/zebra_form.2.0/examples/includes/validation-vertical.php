...
<?php
    ...
    $obj->set_rule(array(
        'required'  => array('error', 'This field is required!'),
        'regexp'    => array('^07\,[0-9]{8}$', 'error', 'Accepts only digits (0 to 9) and/or one minus sign (but only if it is the very first character)')
    ));

    $form->add('note', 'note_regexp', 'regexp', 'Validates if the value satisfies the given regular expression');
